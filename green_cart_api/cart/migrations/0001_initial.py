    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Parent category for hierarchical structure', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='cart.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(blank=True, help_text='Product brand', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='cart.brand')),
                ('categories', models.ManyToManyField(help_text='Categories this product belongs to', related_name='products', to='cart.category')),
                ('tags', models.ManyToManyField(blank=True, help_text='Product tags', related_name='products', to='cart.tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(help_text='Product these images belong to', on_delete=django.db.models.deletion.CASCADE, related_name='images', to='cart.product')),
            ],
            options={
